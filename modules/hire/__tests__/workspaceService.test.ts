...
describe('createWorkspace', () => {
  ...
  it('rejects a second workspace for the same user (409)', async () => {
    ...
    await expect(createWorkspace(ACTOR, 'Other')).rejects.toMatchObject({
      statusCode: 409,
