...
export const STATIC_DEPTHS: StaticDepth[] = [
  ...
  { slug: 'academics', label: 'Academics', icon: '📚', description: 'Campus-style academics round for freshers (0-2 yrs) — name your strongest subject, then get grilled on its fundamentals, theorems/frameworks, and adjacent subjects.', applicableCategories: ['programming', 'data-ai', 'core-engineering', 'business'], applicableExperience: ['0-2'] },
]
