...
### Entry Level (0-2 years)
1. "Which subject did you enjoy most? Suppose you said Thermodynamics — state the first and second laws in your own words, and tell me physically what entropy is."
   - Targets: thermodynamics_laws → follow up on: why entropy of an isolated system never decreases, and the difference between a reversible and an irreversible process
...
1. "Which subject are you strongest in, and why does it appeal to you more than the others?"
   - Targets: subject_selection → follow up on: drill the named subject's fundamentals first, then bridge to its adjacent subject along the natural spine
