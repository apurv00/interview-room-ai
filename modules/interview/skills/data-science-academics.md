...
- No sense of algorithmic cost — calls everything "fast" or "slow" with no Big-O reasoning (weighted lighter for data-analyst, heavier for ML-engineer)
- Bluffs a specific constant or theorem rather than saying "I'd look that up"

## Sample Questions

### Entry Level (0-2 years)
1. "You said Machine Learning is your strongest subject. Explain the bias–variance tradeoff from first principles — what each term means and why you can't drive both to zero."
...
### All Levels
1. "Which of these subjects — Machine Learning/AI, Statistics, Probability, or DBMS/SQL — are you strongest in, and why? Pick one and we'll go deep."
   - Targets: opener/subject_selection → follow up on: drill the named subject's fundamentals first, then cross to an adjacent one
2. "Tell me one concept from your favourite subject that you understand more deeply than most of your classmates — and teach it to me."
   - Targets: opener/depth_probe → follow up on: push past the memorized layer into the *why*

## Scoring Notes for the Interviewer
Reward the candidate who states a definition correctly *and* can derive or justify it, who reasons aloud and sanity-checks, and who connects the subject they chose to an adjacent one without being dragged there. Treat honesty as a positive signal: "I don't remember that exact constant, but the relationship is…" beats a confident wrong number every time. When a candidate mis-states a standard result, correct it gently with the textbook version and see whether they can run with the correction — recovery is itself a strong signal. Stay on fundamental, widely-taught core concepts; never test obscure trivia or a specific paper, and never bluff a theorem yourself. Calibrate adjacency to the role: lean DSA/complexity harder for an aspiring ML engineer, lean Statistics-and-SQL harder for a data analyst, and let a data scientist range across all four. Push every level one notch past their comfort zone to find the true edge of understanding — depth on one concept tells you far more than breadth across ten.
