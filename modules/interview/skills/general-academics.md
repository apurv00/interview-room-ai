...
The target cohort: a final-year student or recent graduate. Expect clean fundamentals in their named favourite subject — a correct core concept *with a reason*, the ability to derive or justify a simple result, and an honest grasp of the assumptions it carries. They may stumble on a chosen adjacent subject; reward honest reasoning ("I haven't gone deep here, but I'd expect…") over a confident wrong recital. Look for first-principles thinking rather than rote recall.

### Mid Level (3-6 years)
An experienced candidate revisiting fundamentals: expect them to connect textbook theory to applied work — not just *what* a concept is but *why* it matters in practice, where it breaks down, and the judgment of when to apply it. Theory must survive contact with practice.

### Senior (7+ years)
Expect cross-subject synthesis and the ability to teach a fundamental cleanly. They should bridge subjects unprompted, know the historical "why" behind a standard approach, and derive a result from scratch. Look for someone who frames the right question before answering it.

## Scoring Emphasis
Evaluate: (1) correctness of the *fundamental* and the ability to *derive / explain the mechanism* rather than recite it; (2) sound reasoning with stated assumptions; (3) breadth — can they make at least one solid adjacency hop into a neighbouring subject; (4) intellectual honesty — "I'm not sure, but reasoning from first principles…" beats a confident wrong answer; (5) the ability to give a concrete example or simple application. Do not penalize a minor arithmetic slip if the method is sound, and do not reward buzzwords without understanding.

## Red Flags
- Recites a definition but cannot explain what it means or why it works
- States a result confidently that is simply wrong, and does not notice on reflection
- Cannot derive or justify even a simple core result in their *own* stated-strongest subject
- Treats every question as recall and never reasons from first principles
- Bluffs a number or a derivation rather than admitting "I'd look that up" or reasoning it out
...
3. "Walk me through how you would derive or justify a basic result in your subject — don't just state it, show me the reasoning."
   - Targets: derivation → follow up on: what each step assumes, and what changes if one assumption is relaxed.
4. "What is a common misconception in your subject, and what is the correct understanding?"
   - Targets: depth_of_understanding → follow up on: probe whether they truly grasp the correction or just memorized it.
5. "Connect your favourite subject to a neighbouring one you also studied — where do they meet?"
   - Targets: breadth → follow up on: probe one fundamental of the adjacent subject.

### Mid Level (3-6 years)
1. "Where does the textbook version of a core concept in your subject break down in practice, and how do you handle it?"
   - Targets: applied_judgment → follow up on: the assumption that fails and the real-world adjustment.
2. "Pick a result you use often and explain not just *what* it is but *why* the standard derivation works the way it does."
   - Targets: mechanism → follow up on: an edge case or a boundary condition.

### Senior (7+ years)
1. "Bridge two subjects from your field and show me how a concept in one explains or constrains the other."
   - Targets: cross_subject_synthesis → follow up on: derive the connection rather than assert it.
2. "Teach me the single most important idea in your subject from scratch — assume I know nothing — and justify every step."
...
Reward the candidate who reasons aloud, derives rather than recites, states the assumptions behind a result, and is honest about the limits of their knowledge. A clean first-principles explanation of *why* something works beats a flawless recital with no understanding. Open on their favourite subject so they start on solid ground, then push one concept at a time until you find the edge of their understanding, then bridge to an adjacent subject. When the candidate errs, correct gently with the standard result and watch whether they integrate the correction. Accept "I'd look up that exact figure" for any specific constant — you are testing understanding, not memory.
