...
export default function StageReview({
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1">
        <h2 className="text-xl font-bold text-white">Review AI Suggestions</h2>
          ...
          {role.enhancedBullets.map((enhanced, i) => {
            ...
            return (
              ...
              >
                {/* Original */}
                <div className="space-y-1">
                  <span className="text-[9px] uppercase tracking-wide text-[#4b5563]">Original</span>
                  ...
                  {isEditing ? (
                    <div className="space-y-2">
                      <textarea
                        ...
                        rows={2}
                        className="w-full bg-card text-sm text-[#f0f2f5] border border-[#6366f1]/30 rounded-md px-3 py-2 focus:outline-none resize-none"
                      />
                    ...
                    <button
                      ...
                      className={`text-[10px] px-2 py-1 rounded-md transition-colors ${
                        decision?.decision === 'accept'
                          ...
                          : 'bg-surface text-[#6b7280] hover:text-emerald-400'
                      }`}
                    >
                      Accept
                    </button>
          ...
          {editingSummary ? (
            <div className="space-y-2">
              <textarea
                ...
                rows={3}
                className="w-full bg-surface text-sm text-[#f0f2f5] border border-[#6366f1]/30 rounded-xl px-3 py-2 focus:outline-none resize-none"
              />
              <div className="flex gap-2">
                <Button size="sm" onClick={() => {
            ...
            <>
              <p className="text-sm text-[#b0b8c4] bg-surface border border-[rgba(255,255,255,0.06)] rounded-xl p-3">
