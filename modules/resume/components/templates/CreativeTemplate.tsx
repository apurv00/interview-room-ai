    ...
    <div className="font-sans text-gray-900 leading-snug" style={{ fontSize: '10px' }}>
      <div className="flex">
        ...
        <div className="w-[20%] bg-[#6366f1] text-white p-3 min-h-full">
          {/* Contact */}
          <div className="mb-4">
            <h2 className="text-[9px] font-bold uppercase tracking-widest border-b border-white/30 pb-0.5 mb-1">Contact</h2>
          ...
          {data.skills && data.skills.length > 0 && (
            <div className="mb-4">
              <h2 className="text-[9px] font-bold uppercase tracking-widest border-b border-white/30 pb-0.5 mb-1">Skills</h2>
          ...
          {data.certifications && data.certifications.length > 0 && (
            <div className="mb-4">
              <h2 className="text-[9px] font-bold uppercase tracking-widest border-b border-white/30 pb-0.5 mb-1">Certifications</h2>
        ...
        <div className="w-[80%] p-3">
          {/* Header */}
          <div className="mb-3">
            <h1 className="text-lg font-bold text-[#6366f1] tracking-wide">{contact.fullName || 'Your Name'}</h1>
          </div>

          {/* Summary */}
          {data.summary && (
            <div className="mb-3">
              <h2 className="text-[9px] font-bold uppercase tracking-widest text-[#6366f1] border-b border-gray-200 pb-0.5 mb-1">About Me</h2>
          ...
          {data.experience && data.experience.length > 0 && (
            <div className="mb-3">
              <h2 className="text-[9px] font-bold uppercase tracking-widest text-[#6366f1] border-b border-gray-200 pb-0.5 mb-1">Experience</h2>
              {data.experience.map(exp => (
                <div key={exp.id} className="mb-2">
                  <div className="flex justify-between items-baseline">
                    <div>
                      <span className="font-bold text-[9px]">{exp.title}</span>
                      {exp.company && <span className="text-[9px] text-[#6366f1]"> | {exp.company}</span>}
                    </div>
          ...
          {data.projects && data.projects.length > 0 && (
            <div className="mb-3">
              <h2 className="text-[9px] font-bold uppercase tracking-widest text-[#6366f1] border-b border-gray-200 pb-0.5 mb-1">Projects</h2>
          ...
          {data.education && data.education.length > 0 && (
            <div className="mb-3">
              <h2 className="text-[9px] font-bold uppercase tracking-widest text-[#6366f1] border-b border-gray-200 pb-0.5 mb-1">Education</h2>
          ...
          {data.customSections?.map(section => (
            <div key={section.id} className="mb-3">
              <h2 className="text-[9px] font-bold uppercase tracking-widest text-[#6366f1] border-b border-gray-200 pb-0.5 mb-1">{section.title}</h2>
