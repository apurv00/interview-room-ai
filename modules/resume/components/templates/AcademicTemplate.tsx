  ...
  return (
    <div className="font-serif text-gray-900 leading-snug" style={{ fontSize: '10px' }}>
      ...
      <div className="text-center border-b-2 border-blue-700 pb-1.5 mb-2">
        <h1 className="text-lg font-bold tracking-wide">{contact.fullName || 'Your Name'}</h1>
      ...
      {data.summary && (
        <div className="mb-2">
          <h2 className="text-[9px] font-bold uppercase tracking-widest text-blue-700 border-b border-blue-300 pb-0.5 mb-1">Research Interests</h2>
      ...
      {data.education && data.education.length > 0 && (
        <div className="mb-2">
          <h2 className="text-[9px] font-bold uppercase tracking-widest text-blue-700 border-b border-blue-300 pb-0.5 mb-1">Education</h2>
      ...
      {data.experience && data.experience.length > 0 && (
        <div className="mb-2">
          <h2 className="text-[9px] font-bold uppercase tracking-widest text-blue-700 border-b border-blue-300 pb-0.5 mb-1">Research Experience</h2>
      ...
      {data.skills && data.skills.length > 0 && (
        <div className="mb-2">
          <h2 className="text-[9px] font-bold uppercase tracking-widest text-blue-700 border-b border-blue-300 pb-0.5 mb-1">Technical Skills</h2>
      ...
      {data.projects && data.projects.length > 0 && (
        <div className="mb-2">
          <h2 className="text-[9px] font-bold uppercase tracking-widest text-blue-700 border-b border-blue-300 pb-0.5 mb-1">Projects</h2>
      ...
      {data.certifications && data.certifications.length > 0 && (
        <div className="mb-2">
          <h2 className="text-[9px] font-bold uppercase tracking-widest text-blue-700 border-b border-blue-300 pb-0.5 mb-1">Certifications</h2>
      ...
      {data.customSections?.map(section => (
        <div key={section.id} className="mb-2">
          <h2 className="text-[9px] font-bold uppercase tracking-widest text-blue-700 border-b border-blue-300 pb-0.5 mb-1">{section.title}</h2>
