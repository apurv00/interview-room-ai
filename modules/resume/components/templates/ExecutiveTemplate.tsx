...
export default function ExecutiveTemplate({ data }: TemplateProps) {
  ...
  return (
    <div className="font-serif text-gray-900 leading-snug" style={{ fontSize: '10px' }}>
      {/* Header */}
      <div className="text-center mb-3">
        <h1 className="text-xl font-bold tracking-widest uppercase text-[#1e293b]">{contact.fullName || 'Your Name'}</h1>
      ...
      {data.summary && (
        <div className="mb-3">
          <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#1e293b] border-b-2 border-[#1e293b] pb-0.5 mb-1">Executive Summary</h2>
          <p className="text-[9px] text-gray-700 leading-relaxed italic">{data.summary}</p>
        </div>
      )}
      ...
      {data.experience && data.experience.length > 0 && (
        <div className="mb-3">
          <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#1e293b] border-b-2 border-[#1e293b] pb-0.5 mb-1">Key Achievements &amp; Experience</h2>
          {data.experience.map(exp => (
            <div key={exp.id} className="mb-2">
              <div className="flex justify-between items-baseline">
                <div>
                  <span className="font-bold text-[9px] uppercase">{exp.title}</span>
      ...
      {data.education && data.education.length > 0 && (
        <div className="mb-3">
          <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#1e293b] border-b-2 border-[#1e293b] pb-0.5 mb-1">Education</h2>
      ...
      {data.skills && data.skills.length > 0 && (
        <div className="mb-3">
          <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#1e293b] border-b-2 border-[#1e293b] pb-0.5 mb-1">Core Competencies</h2>
      ...
      {data.projects && data.projects.length > 0 && (
        <div className="mb-3">
          <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#1e293b] border-b-2 border-[#1e293b] pb-0.5 mb-1">Notable Projects</h2>
      ...
      {data.certifications && data.certifications.length > 0 && (
        <div className="mb-3">
          <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#1e293b] border-b-2 border-[#1e293b] pb-0.5 mb-1">Certifications &amp; Credentials</h2>
      ...
      {data.customSections?.map(section => (
        <div key={section.id} className="mb-3">
          <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#1e293b] border-b-2 border-[#1e293b] pb-0.5 mb-1">{section.title}</h2>
