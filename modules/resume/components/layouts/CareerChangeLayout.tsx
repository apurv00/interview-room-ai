...
import { CAREER_CHANGE_ORDER, resolveSectionOrder, type BodySectionId } from '../../config/sectionOrders'
...
export default function CareerChangeLayout({ data, variantId }: Props) {
  ...
  const order = resolveSectionOrder(data.sectionOrder, CAREER_CHANGE_ORDER)
