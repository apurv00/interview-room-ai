 ...
 * /share-packet/<id>, and /candidate/<roundId> carry a secret in the path whose server-side value
 ...
 */
const SECRET_PATH_RE = /^\/(apply|scorecard|candidate|interview-kit|share-packet)\/[^/]+/
