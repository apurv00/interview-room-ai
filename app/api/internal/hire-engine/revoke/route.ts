...
import { revokeRuntimeBinding } from '@modules/hire-runtime/services/revocationService'

export const dynamic = 'force-dynamic'
const ROUTE_PATH = '/api/internal/hire-engine/revoke'
...
export async function POST(req: NextRequest) {
  ...
  try {
    const result = await revokeRuntimeBinding(JSON.parse(body))
