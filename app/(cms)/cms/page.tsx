...
export default function CmsDashboard() {
  ...
  if (loading) {
    return <div className="text-[#536471]">Loading dashboard...</div>
  }
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {cards.map((card) => (
          <div
            key={card.title}
            className="bg-white border border-[#e1e8ed] rounded-xl p-6"
          >
            <p className="text-sm text-[#536471] mb-1">{card.title}</p>
