    ...
    <main className="min-h-screen">
      ...
      <section className="px-4 sm:px-6 pt-20 pb-region">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <p className="text-body text-[#71767b] mt-4 max-w-lg mx-auto">
      ...
      <section className="px-4 sm:px-6 py-section">
        <div className="max-w-[1000px] mx-auto text-center">
          ...
          <Link href="/signup" className="text-caption text-[#6366f1] hover:text-[#4f46e5] transition-colors mt-4 inline-block">
      ...
      <section className="px-4 sm:px-6 py-section">
        <div className="max-w-[1000px] mx-auto text-center">
          ...
          <Link href="/pricing" className="text-caption text-[#6366f1] hover:text-[#4f46e5] transition-colors mt-4 inline-block">
      ...
      <section className="px-4 sm:px-6 py-region text-center">
        ...
        <p className="text-body text-[#71767b] mt-2">Free to start — no credit card required.</p>
