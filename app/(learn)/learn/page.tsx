  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Link
          href="/learn/guides"
          className="block p-6 rounded-xl border border-[#e1e8ed] hover:border-blue-500 transition-colors"
        >
        ...
        <Link
          href="/learn/pathway"
          className="block p-6 rounded-xl border border-[#e1e8ed] hover:border-emerald-500 transition-colors"
        >
        ...
        <Link
          href="/practice/drill"
          className="block p-6 rounded-xl border border-[#e1e8ed] hover:border-amber-500 transition-colors"
        >
        ...
        <Link
          href="/dashboard"
          className="block p-6 rounded-xl border border-[#e1e8ed] hover:border-purple-500 transition-colors"
        >
