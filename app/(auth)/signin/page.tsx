    ...
    <main className="min-h-screen bg-page flex items-center justify-center px-4 sm:px-6">
      <div className="w-full max-w-[640px]">
        <div className="surface-card-bordered p-7 sm:p-8">
          ...
          <h1 className="text-heading text-[#f0f2f5] text-center">Sign in</h1>
          ...
          <p className="text-caption text-[#4b5563] text-center mt-section">
            ...
            <Link href="/signup" className="text-[#818cf8] hover:text-[#6366f1] transition-colors">
              Sign up
            </Link>
          </p>
        </div>
        ...
        <p className="text-caption text-[#4b5563] text-center mt-4">
          ...
          <Link href="/" className="text-[#818cf8] hover:text-[#6366f1] transition-colors">
            Learn more &rarr;
          </Link>
        </p>
      </div>
