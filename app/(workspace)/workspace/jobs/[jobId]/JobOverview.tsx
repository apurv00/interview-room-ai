    ...
    <div className="space-y-6">
      ...
      {manageAction === 'department' ? (
        <form onSubmit={changeDepartment} className="rounded-2xl border border-[#dbe4ea] bg-white p-5" aria-labelledby="change-department-title">
          <h2 ref={manageSectionHeadingRef} id="change-department-title" tabIndex={-1} className="font-semibold text-[#0f1419]">Change department</h2>
      ...
      {manageAction === 'duplicate' ? (
        <section className="rounded-2xl border border-[#dbe4ea] bg-white p-5" aria-labelledby="duplicate-title">
          <h2 ref={manageSectionHeadingRef} id="duplicate-title" tabIndex={-1} className="font-semibold text-[#0f1419]">Duplicate job</h2>
      ...
      {manageAction === 'close' ? (
        <form onSubmit={closeJob} className="rounded-2xl border border-amber-200 bg-white p-5" aria-labelledby="close-job-title">
          <h2 ref={manageSectionHeadingRef} id="close-job-title" tabIndex={-1} className="font-semibold text-[#0f1419]">Close this job</h2><p className="mt-1 text-sm text-[#536471]">A decision note is required. Active candidates will be resolved by the existing close lifecycle.</p>
      ...
      {manageAction === 'delete' ? (
        <form onSubmit={deleteJob} className="rounded-2xl border border-red-200 bg-white p-5" aria-labelledby="delete-job-title">
          <h2 ref={manageSectionHeadingRef} id="delete-job-title" tabIndex={-1} className="font-semibold text-red-800">Delete this empty job</h2><p className="mt-1 text-sm text-[#536471]">This is permanent. The server will stop the action if any hiring activity exists.</p>
